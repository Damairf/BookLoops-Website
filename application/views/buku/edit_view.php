                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
								 ...
								 <div class="form-group">
                                    <label>Buku ID</label>
                                    <input type="text" class="form-control" value="<?= $buku->buku_id;?>" name="buku_id"  placeholder=">
                                </div>
                                <div class="form-group">
                                    <label>ISBN</label>
								...
								<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?= $buku->no_klasifikasi;?>" name="no_klasifikasi"  placeholder="Contoh : 899.221 3">
                                </div>
                                <div class="form-group">
