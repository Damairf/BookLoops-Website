...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/view.jpg');?>')no-repeat; background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <a href="index.php" style="color: #355432;">Selamat Datang di<br/><b>Bookloops Library</b></a>
  </div>
  <div id="tampilalert"></div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="border:2px solid #355432;">
    <p class="login-box-msg" style="font-size:16px;"></p>
    <form action="<?= base_url('login/auth');?>" method="POST">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder{
		color: blue;} placeholder="Username" id="user" name="user" required="required" autocomplete="off">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          <button type="submit" id="ldoding" class="btn btn-primary btn-block btn-flat" style="background-color: #355432; border-color: #355432;">
  Sign In
</button>
  ...
  <br/>
  <footer>
    <div class="login-box-body text-center bg-cream">
       <a style="color: black;"> Copyright &copy; bookloops library - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
